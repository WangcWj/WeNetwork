...
public class NetException  {
    ...
    public NetException(Throwable e) {
        ...
        Toast.makeText(App.getInstance().getApplicationContext(), errorMessage, Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean success(){
        if(SUCCESS_CODE == mCode){
            ...
            Toast.makeText(App.getInstance().getApplicationContext(), mMessage, Toast.LENGTH_SHORT).show();
            return false;
        }
    }
