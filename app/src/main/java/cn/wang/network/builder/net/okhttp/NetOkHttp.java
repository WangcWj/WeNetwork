package cn.wang.network.builder.net.okhttp;

import java.util.List;
import java.util.concurrent.TimeUnit;

import cn.wang.network.builder.net.base.BaseParam;
import cn.wang.network.builder.net.intercepter.LogInterceptor;
import cn.wang.network.builder.net.intercepter.NetInterceptorFactory;
