...
public interface ApiService {
    ...
    //返回的data一定为数组的时候这样使用
    @GET("meituApi")
    Observable<NetBaseResultBean<List<JokeBean>>> getSingleData(@QueryMap Map<String, Object> params);
    ...
    @GET("weatherApi")
    Observable<NetBaseResultBean<WeatherBean>> getCityWeather(@QueryMap Map<String, Object> params);
